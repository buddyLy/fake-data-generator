...
public class FakeDataGenerator {
	...
	public String getXref() {
		Integer tendertype=df.getNumberUpTo(9);
		String acct_nbr=df.getNumberText(9);
		return tendertype.toString()+"_"+acct_nbr;
	}
	public void setXref(String xref) {
		Xref = xref;
	}
	public String getXrefType() {
		Integer xreftype=df.getNumberUpTo(99);
		return xreftype.toString();
	}
